...
MSG_HASH(
   ...
   MENU_ENUM_LABEL_ROM_LIBRARY_LIST_STR
   )
MSG_HASH(
   MENU_ENUM_LABEL_ROM_LIBRARY_SETTINGS,
   MENU_ENUM_LABEL_ROM_LIBRARY_SETTINGS_STR
   )
MSG_HASH(
   MENU_ENUM_LABEL_DEFERRED_ROM_LIBRARY_ENTRIES,
   MENU_ENUM_LABEL_DEFERRED_ROM_LIBRARY_ENTRIES_STR
   )
MSG_HASH(
   MENU_ENUM_LABEL_ROM_LIBRARY_ENTRY,
   MENU_ENUM_LABEL_ROM_LIBRARY_ENTRY_STR
   )
MSG_HASH(
   MENU_ENUM_LABEL_ROM_LIBRARY_SETTING_URL,
   MENU_ENUM_LABEL_ROM_LIBRARY_SETTING_URL_STR
   )
MSG_HASH(
   MENU_ENUM_LABEL_ROM_LIBRARY_SETTING_USERNAME,
   MENU_ENUM_LABEL_ROM_LIBRARY_SETTING_USERNAME_STR
   )
MSG_HASH(
   MENU_ENUM_LABEL_ROM_LIBRARY_SETTING_PASSWORD,
   MENU_ENUM_LABEL_ROM_LIBRARY_SETTING_PASSWORD_STR
   )
/* === ROM_LIBRARY END === */
