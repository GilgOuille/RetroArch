...
/* === ROM_LIBRARY BEGIN === */
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_ROM_LIBRARY_LIST,
   "Online ROM Library"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_ROM_LIBRARY_SETTINGS,
   "ROM Library Settings"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_DEFERRED_ROM_LIBRARY_ENTRIES,
   "ROMs"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_ROM_LIBRARY_ENTRY,
   "ROM"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_ROM_LIBRARY_SETTING_URL,
   "Server URL"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_ROM_LIBRARY_SETTING_USERNAME,
   "Username"
   )
MSG_HASH(
