...
/* === ROM_LIBRARY BEGIN === */
   MENU_LABEL(ROM_LIBRARY_LIST),
   MENU_LABEL(ROM_LIBRARY_SETTINGS),
   MENU_LABEL(DEFERRED_ROM_LIBRARY_ENTRIES),
   MENU_LABEL(ROM_LIBRARY_ENTRY),
   MENU_LABEL(ROM_LIBRARY_SETTING_URL),
   MENU_LABEL(ROM_LIBRARY_SETTING_USERNAME),
   MENU_LABEL(ROM_LIBRARY_SETTING_PASSWORD),
/* === ROM_LIBRARY END === */
